 ...
 * @author Nantodd
 */
public class FormLapAkhir extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormLapAkhir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
